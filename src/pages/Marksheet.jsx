      ...
      <style>{`
        ...
        @media print {
          * { box-sizing: border-box; }
          ...
          .marksheet-wrap {
            /* Scale the whole marksheet to fit A4 */
            /* A4 printable width ~197mm = ~744px at 96dpi */
            /* Our design is 680px wide, after 6mm margins = 680px target */
      ...
      <div className="print-outer p-3 pb-8">
        <div ref={marksheetRef}
          ...
          <div style={{ background: 'linear-gradient(135deg,#0a1628 0%,#1a3a5c 55%,#1e5a8e 100%)' }}>
            <div style={{ padding: '20px 28px 10px', textAlign: 'center', position: 'relative' }}>
              <div style={{ position:'absolute',top:-16,right:-16,width:80,height:80,borderRadius:'50%',background:'rgba(240,165,0,0.07)' }}/>
              <div style={{ width:56,height:56,borderRadius:16,margin:'0 auto 10px',display:'flex',alignItems:'center',justifyContent:'center',background:'linear-gradient(135deg,#f0a500,#fbbf24)',boxShadow:'0 8px 24px rgba(240,165,0,0.4)' }}>
                <GraduationCap size={26} color="#0a1628"/>
              </div>
              <h1 className="bangla" style={{ fontSize:18,fontWeight:700,color:'#fff',lineHeight:1.2 }}>গোল্ডেন লাইফ পাবলিক স্কুল</h1>
              <p className="bangla" style={{ fontSize:11,color:'#bfdbfe',marginTop:3 }}>পাইকরতলী, কাজিপুর, সিরাজগঞ্জ &nbsp;|&nbsp; ০১৭৩৩৬৯৬৪৭৭</p>
              <p className="bangla" style={{ fontSize:10,color:'rgba(147,197,253,0.7)',marginTop:2 }}>স্থাপিতঃ ২০১৫ &nbsp;|&nbsp; পরিচালকঃ ডাঃ মোঃ আমিনুল ইসলাম</p>
              <div style={{ marginTop:10,marginLeft:-28,marginRight:-28,padding:'6px 28px',background:'rgba(240,165,0,0.15)',borderTop:'1px solid rgba(240,165,0,0.4)',borderBottom:'1px solid rgba(240,165,0,0.4)' }}>
                <p className="bangla" style={{ fontSize:13,fontWeight:700,color:'#fbbf24' }}>✦ প্রগতি পত্র / মার্কশীট ✦</p>
                {student.exam_type && <p className="bangla" style={{ fontSize:10,color:'rgba(251,191,36,0.72)',marginTop:2 }}>{student.exam_type} · {student.exam_year}</p>}
              </div>
            </div>
          </div>

          {/* STUDENT INFO */}
          <div style={{ padding:'8px 16px',background:'#f8fafc',borderBottom:'2px solid #e2e8f0' }}>
            <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:6 }}>
              <div style={{ gridColumn:'1/-1',padding:'6px 12px',background:'#fff',border:'1px solid #e2e8f0',borderRadius:10 }}>
                <p style={{ fontSize:8,fontWeight:600,color:'#94a3b8',textTransform:'uppercase',letterSpacing:'0.05em' }}>শিক্ষার্থীর নাম</p>
              ...
              {[
                ...
                <div key={label} style={{ padding:'5px 10px',background:'#fff',border:'1px solid #e2e8f0',borderRadius:10 }}>
                  <p style={{ fontSize:8,fontWeight:600,color:'#94a3b8',textTransform:'uppercase' }}>{label}</p>
          ...
          {/* RESULT BANNER */}
          <div style={{ margin:'6px 14px',borderRadius:12,overflow:'hidden',border:`1.5px solid ${result.passed?'#6ee7b7':'#fca5a5'}` }}>
            <div style={{ background:result.passed?'linear-gradient(135deg,#064e3b,#065f46)':'linear-gradient(135deg,#7f1d1d,#991b1b)',padding:'10px 14px',display:'flex',alignItems:'center',gap:12 }}>
              ...
              <div style={{ flex:1 }}>
                <p className="bangla" style={{ fontWeight:700,color:'#fff',fontSize:15 }}>{result.passed?'✓ উত্তীর্ণ':'✗ অনুত্তীর্ণ'}</p>
          ...
          {/* GRADE SCALE + SUMMARY */}
          <div style={{ margin:'6px 14px',display:'grid',gridTemplateColumns:'1fr 1fr',gap:10 }}>
            <div style={{ padding:'8px 10px',borderRadius:10,background:'#f8fafc',border:'1px solid #e2e8f0' }}>
              <p className="bangla" style={{ fontSize:9,fontWeight:700,marginBottom:6,color:'#64748b',textTransform:'uppercase' }}>গ্রেড স্কেল</p>
            ...
            <div style={{ padding:'8px 10px',borderRadius:10,background:'#f8fafc',border:'1px solid #e2e8f0' }}>
              <p className="bangla" style={{ fontSize:9,fontWeight:700,marginBottom:6,color:'#64748b',textTransform:'uppercase' }}>সারসংক্ষেপ</p>
          ...
          {/* SIGNATURES */}
          <div style={{ margin:'6px 14px 10px',display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:20 }}>
          ...
          {/* FOOTER */}
          <div style={{ padding:'7px 14px',textAlign:'center',background:'linear-gradient(90deg,#0a1628,#1a3a5c)' }}>
